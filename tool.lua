...
-- Add a button for the speed control in Tab 1
Tab1:AddButton({
    Name = "Activate Speed Control",
    Callback = function()
        local speedValue = 16 -- Default speed value

        -- Create GUI when button is pressed
...
-- Add high jump feature to Tab 1
Tab1:AddButton({
    Name = "Activate High Jump",
    Callback = function()
        player.Character.Humanoid.JumpPower = 100 -- Default high jump value
    end
})

-- Add low gravity feature to Tab 1
Tab1:AddButton({
    Name = "Activate Low Gravity",
    Callback = function()
        game.Workspace.Gravity = 20 -- Default low gravity value (normal is 196.2)
    end
})

-- Tab 2 - Fly, YARHM, and FE Emote Scripts
...
-- Add YARHM script button to Tab 2
Tab2:AddButton({
...
-- Add FE Emote script button to Tab 2
Tab2:AddButton({
    Name = "Load FE Emote Script",
    Callback = function()
        loadstring(game:HttpGet("https://pastebin.com/raw/eCpipCTH"))()
    end
})

-- Add Trench War Script button to Tab 2
Tab2:AddButton({
    Name = "Load Trench War Script",
    Callback = function()
        setclipboard('https://discord.com/invite/R9ZFKmZqaH')

local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))();
_G.closeBind = Enum.KeyCode.P

local win = lib:Window("Trench War", "Made by: Prince API and exploitns", Color3.fromRGB(255, 110, 48), _G.closeBind);
